...
export const VIDEO_ASSETS = {
  /** Landing “Give” circle video — file: `give-loop.mp4` in Supabase `app-assets` */
  ...
  // Upload your video to: assets/videos/donation-explainer.mp4 then run: npm run upload-assets
